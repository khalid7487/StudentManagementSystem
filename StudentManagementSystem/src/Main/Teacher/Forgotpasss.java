...
public class Forgotpasss extends javax.swing.JFrame {
   ...
   PreparedStatement pst = null;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            String sql = "select * from telogin,teinfo where telogin.ID=teinfo.ID and teinfo.Email=? ";
    ...
    private void closeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeActionPerformed
        this.dispose();
        TeacherLogin.user.setEnabled(true);
        TeacherLogin.pass.setEnabled(true);
        TeacherLogin.lg.setEnabled(true);
        TeacherLogin.fgt.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Forgotpasss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Forgotpasss().setVisible(true);
            }
        });
    }
