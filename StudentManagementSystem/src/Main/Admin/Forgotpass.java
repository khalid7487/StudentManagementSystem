...
public class Forgotpass extends javax.swing.JFrame {
   ...
   PreparedStatement pst = null;
    ...
    private void closeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_closeActionPerformed
        this.dispose();
        adminlogin.user.setEnabled(true);
        adminlogin.pass.setEnabled(true);
        adminlogin.lg.setEnabled(true);
        adminlogin.fgt.setEnabled(true);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            String sql = "select * from adminlogin,admininfo where adminlogin.ID=admininfo.ID and admininfo.Email=? ";
