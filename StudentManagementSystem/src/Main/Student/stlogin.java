...
public class stlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        stlg.setForeground(new java.awt.Color(51, 204, 255));
        ...
        jPanel2.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 650, 1246, 40));
    ...
    private void lgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lgActionPerformed
        conn=Connect.Studentdb();
        String sql = "select * from stlogin,stinfo,stgurdian,payment where stinfo.ID=stlogin.ID and stlogin.ID=stgurdian.ID and stlogin.ID=payment.ID and "
                + "stlogin.ID=? and stlogin.password = ?";
        ...
        try {
            ...
            rs = pst.executeQuery();
            if (rs.next()) {
                stprofile ad = new stprofile();
                ad.setVisible(true);
                String a = rs.getString("ID");
                stprofile.usern.setText(a);
                String b = rs.getString("Name");
                stprofile.nam.setText(b);
                stprofile.name.setText(b);
                String c = rs.getString("Mobile");
                stprofile.phn.setText(c);
                stprofile.mob.setText(c);
                String d = rs.getString("Nickname");
                stprofile.nck.setText(d);
                String e = rs.getString("Gender");
                stprofile.gen.setText(e);
                String f = rs.getString("Bloodgroup");
                stprofile.bldd.setText(f);
                stprofile.bld.setText(f);
                String g = rs.getString("MaritalStatus");
                stprofile.mar.setText(g);
                String h = rs.getString("Religion");
                stprofile.rlgn.setText(h);
                String i = rs.getString("Nationality");
                stprofile.national.setText(i);
                String j = rs.getString("nationalID");
                stprofile.nid.setText(j);
                String k = rs.getString("SocialnetID");
                stprofile.fb.setText(k);
                String l = rs.getString("Email");
                stprofile.eml.setText(l);
                String m = rs.getString("Alternativeemail");
                stprofile.alem.setText(m);
                String n = rs.getString("Dob");
                stprofile.dobb.setText(n);
                stprofile.dob.setText(n);
                String p = rs.getString("f_name");
                stprofile.fname2.setText(p);
                String q = rs.getString("m_name");
                stprofile.mname2.setText(q);
                String r = rs.getString("Totalpayble");
                stprofile.payble.setText(r);
                String s = rs.getString("Totalpaid");
                stprofile.paid.setText(s);
                String y = rs.getString("Totatdue");
                stprofile.due.setText(y);
                this.dispose();
            } else {
